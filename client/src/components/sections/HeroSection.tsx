    ...
    <section className="relative pt-40 pb-20 px-6 max-w-5xl mx-auto w-full text-center flex flex-col items-center z-10">
      ...
      >
        <button 
          ...
          className="h-12 px-8 rounded-xl bg-white text-black font-semibold flex items-center gap-2 hover:bg-zinc-200 transition-all shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] hover:scale-105 active:scale-95"
        >
